      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg">Conference Hub</span>
            </div>
            <p className="text-sm text-muted-foreground max-w-xs">
              A comprehensive room booking and resource management system designed to streamline the process of reserving meeting spaces.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/conference-room-booking" className="text-sm hover:text-primary transition-colors">
                  Room Booking
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="font-medium text-sm mb-4 text-muted-foreground uppercase tracking-wider">Contact</h3>
            <ul className="space-y-3">
        ...
        <div className="border-t mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-muted-foreground">
            © {currentYear} Conference Hub. All rights reserved.
          </p>
